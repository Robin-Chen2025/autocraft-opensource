        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="执行开始时间">
              <el-date-picker v-model="formData.exec_start_time" type="datetime" placeholder="选择时间" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="预计执行完成时间">
              <el-date-picker v-model="formData.exec_estimated_complete" type="datetime" placeholder="选择时间" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="实际执行完成时间">
              <el-date-picker v-model="formData.exec_complete_time" type="datetime" placeholder="选择时间" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-card>
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="验证开始时间">
              <el-date-picker v-model="formData.verify_start_time" type="datetime" placeholder="选择时间" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="预计验证完成时间">
              <el-date-picker v-model="formData.verify_estimated_complete" type="datetime" placeholder="选择时间" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="实际验证完成时间">
              <el-date-picker v-model="formData.verify_complete_time" type="datetime" placeholder="选择时间" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="24">
            <el-form-item label="验证日志">
              <el-input v-model="formData.verification_log" type="textarea" :rows="4" placeholder="请输入验证日志" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-card>
...
// Emits 定义
interface TaskExecutionFormEmits {
...
// 从 URL 参数获取 taskNo
const urlTaskNo = computed(() => route.query.taskNo as string | undefined)

// 是否为编辑模式（优先使用 props，否则使用 URL 参数）
const isEditMode = computed(() => !!(props.taskNo || urlTaskNo.value))

// 获取当前 taskNo（props 或 URL 参数）
const currentTaskNo = computed(() => props.taskNo || urlTaskNo.value)
...
const loadTaskData = async () => {
  ...
  try {
    ...
    const task: Task = await getTaskDetail(taskNo)
    ...
    formData.value = {
      ...
      exec_start_time: task.exec_start_time,
      exec_estimated_complete: task.exec_estimated_complete,
      exec_complete_time: task.exec_complete_time,
      verify_start_time: task.verify_start_time,
      verify_estimated_complete: task.verify_estimated_complete,
      verify_complete_time: task.verify_complete_time,
    }
  } catch (error) {
  ...
  try {
    ...
    if (isEditMode.value) {
      ...
      const updateData: UpdateTaskRequest = {
        ...
        verification_log: formData.value.verification_log,
        exec_start_time: formData.value.exec_start_time,
        exec_estimated_complete: formData.value.exec_estimated_complete,
        exec_complete_time: formData.value.exec_complete_time,
        verify_start_time: formData.value.verify_start_time,
        verify_estimated_complete: formData.value.verify_estimated_complete,
        verify_complete_time: formData.value.verify_complete_time,
      }
      await updateTask(taskNo, updateData)
